    ...
    <div className="h-screen flex flex-col">
      <header className="bg-white py-4">
        <div className="container mx-auto flex justify-between items-center">
          {/* Placeholder para alinhar o botão à direita */}
          <div></div>

          {/* Botão de Logout */}
          <button className="hover:bg-blue-700 bg-[#02274F] w-[272px] h-[44px] text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline ml-auto">
            Logout
          </button>
        </div>
      </header>
      ...
      <div className="flex flex-grow items-center justify-center bg-gray-100">
        <div className="bg-white shadow-lg w-[438px] mx-auto p-8 rounded-3xl mb-[95px]">
          {/* Contêiner para centralizar o título e a imagem */}
          <div className="flex flex-col items-center mb-8">
            {/* Título "Profile Picture" */}
